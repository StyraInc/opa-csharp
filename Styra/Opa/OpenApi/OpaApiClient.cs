...
namespace Styra.Opa.OpenApi
{
    ...
    public class OpaApiClient: IOpaApiClient
    {
        ...
        private const string _sdkVersion = "1.3.7";
        private const string _sdkGenVersion = "2.415.7";
        private const string _openapiDocVersion = "0.2.0";
        private const string _userAgent = "speakeasy-sdk/csharp 1.3.7 2.415.7 0.2.0 Styra.Opa.OpenApi";
        private string _serverUrl = "";
        private int _serverIndex = 0;
        private ISpeakeasyHttpClient _client;
        private Func<Styra.Opa.OpenApi.Models.Components.Security>? _securitySource;
        ...
        public OpaApiClient(string? bearerAuth = null, Func<string>? bearerAuthSource = null, int? serverIndex = null, string? serverUrl = null, Dictionary<string, string>? urlParams = null, ISpeakeasyHttpClient? client = null, RetryConfig? retryConfig = null)
        {
            ...
            {
                _securitySource = () => new Styra.Opa.OpenApi.Models.Components.Security() { BearerAuth = bearerAuthSource() };
            }
            else if(bearerAuth != null)
            {
                _securitySource = () => new Styra.Opa.OpenApi.Models.Components.Security() { BearerAuth = bearerAuth };
            }
